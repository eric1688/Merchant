...
import CFRecommendation.DataProcessing.step2.UserVectorToCooccurrenceMapper;
import CFRecommendation.DataProcessing.step2.UserVectorToCooccurrenceReducer;
import CFRecommendation.DataProcessing.step3.UserVectorSplitterMapper;
import CFRecommendation.DataProcessing.step4.ToVectorAndPrefReducer;
import CFRecommendation.DataProcessing.step5.AggregateAndRecommendReducer;
import CFRecommendation.DataProcessing.step5.PartialMultiplyMapper;
import CFRecommendation.DataProcessing.step6.ItemToRecommenderReducer;
...
public class CFRecommenderDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		/*
		 * .setNumReduceTasks() 它用来设置作业在reduce阶段被分为几个reduce任务来完成，
		 * 这个值决定了每一个map任务最后的输出结果被分为多少个部分，而每一个部分将交由不同的ruduce来处。
		 * 对应配置文件mapred-site.xml中的mapred.reduces.tasks项
		 */
...
//		job1.setReducerClass(ToUserVectorReducer.class);
...
//
//		FileInputFormat.addInputPath(job1, new Path(CFRecommenderJob.InputPath));
//		Path outPath1 = new Path(Util.HDFS + "/CFRecommender/tmp/step15/step1");
...
//				+ "/CFRecommender/tmp/step15/step1"));
//		Path outPath2 = new Path(Util.HDFS + "/CFRecommender/tmp/step23/step2");
...
//
//		FileInputFormat.addInputPath(job3, new Path(Util.HDFS
//				+ "/CFRecommender/tmp/step15/step1"));
//		Path outPath3 = new Path(Util.HDFS + "/CFRecommender/tmp/step23/step3");
...
//
//		FileInputFormat.addInputPath(job4, new Path(Util.HDFS
//				+ "/CFRecommender/tmp/step23/step*/"));
//		Path outPath4 = new Path(Util.HDFS + "/CFRecommender/tmp/step4");
...
//
//		FileInputFormat.addInputPath(job5, new Path(Util.HDFS
//				+ "/CFRecommender/tmp/step4"));
//		Path outPath5 = new Path(Util.HDFS + "/CFRecommender/tmp/step15/step5");
...
//
//		FileInputFormat.addInputPath(job6, new Path(Util.HDFS
//				+ "/CFRecommender/tmp/step15/step*/"));
